...
const style ={
  wrapper: `flex-[1] p-4`,
  searchBar: `flex items-center bg-[#243340] rounded-3xl p-2`,
  ...
  item: `flex items-center p-2 my-2 hover:bg-[#22303c] cursor-pointer`,
  newsItemLeft: `flex-1`,
  newsItemCategory: `text-[#8899a6] text-xs font-semibold`,
  newsItemTitle: `text-sm font-bold`,
  newsItemRight: `ml-3 w-1/5`,
  newsItemImage: `rounded-xl w-14 h-14 object-cover`,
  followAvatarContainer: `w-1/6`,
  followAvatar: `rounded-full h-[40x] w-[40px]`,
